const mihralb = {
  ...
  highlights: [
    'Co-built a journalism website for a real client, working on everything from the design of components to getting it live.',
  ...
  links: {
    live: 'https://mihralb.com',
    github: null,
  },
}

export default mihralb